...
const RecommendationPage = ({ predictionData, darkMode, onBack }) => {
    ...
    const fetchRecommendations = async () => {
      ...
      try {
        ...
        console.log("Fetching recommendations with data:", {
          ...
          ActivityLevel: predictionData.ActivityLevel || "Low", // Fallback to "Low"
          Goal: predictionData.Goal || "Maintain", // Fallback if missing
        ...
        const response = await fetch("http://127.0.0.1:5000/recommend", {
          ...
          body: new URLSearchParams({
            Age: predictionData.Age || "30", // Fallback
            Height: heightInMeters,
            Weight: predictionData.Weight || "70", // Fallback
            Sex: predictionData.Sex || "Male", // Fallback
            ActivityLevel: predictionData.ActivityLevel || "Low", // Fallback
            Goal: predictionData.Goal || "Maintain", // Fallback
  ...
  return (
    <div
      className={`p-6 max-w-4xl mx-auto rounded-lg shadow-md ${
    ...
    >
      ...
      {activeTab === "dietplan" && !loading && !error && (
        <DietPlan
          recommendationData={nutritionData}
          predictionData={predictionData}
          darkMode={darkMode}
        />
      )}
